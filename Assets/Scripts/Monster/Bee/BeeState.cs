...
namespace BeeStates
{
    ...
    public abstract class BeeState : StateBase<State, Bee>
    {
        ...
        protected int patrolIndex { get { return owner.patrolIndex; } set { patrolIndex = value; } }
        ...
        protected Transform[] patrolPoints { get { return owner.patrolPoints; } set { patrolPoints = value; } }
